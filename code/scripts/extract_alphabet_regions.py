...
if __name__=='__main__':
    ...
    parser.add_argument("threshold", type=float, help="fraction of sequence in first half of alphabet threshold")
    ...
    with outFile:
        ...
        writer.writeheader()
        for orf in orfs:
            region_boundaries = fc.find_alphabet_start_end(orf.seq, args.win_size,\
            ...
            for i in region_boundaries:
                ...
                rv['fraction.first'] = fc.get_alphabet_fraction(region_seq)
                writer.writerow(rv)
